  ...
  <div class="content-wrapper">
	...
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Capres BEM - Edit</li>
      </ol>
	</section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Calon Presiden BEM</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="" method="post" enctype="multipart/form-data">
              <div class="box-body">
				<div class="form-group col-md-6">
					...
					<input readonly="true" value="<?php echo $capresbem->cprs_nim ?>" type="text" class="form-control" required id="cprs_nim" name="cprs_nim" placeholder="Masukkan NIM">
				</div>
				<div class="form-group col-md-6">
					<label for="cprs_nama">Nama<span class="text-danger"><b style="color: red">*</b></span></label>
					<input value="<?php echo $capresbem->cprs_nama ?>" type="text" class="form-control" required id="cprs_nama" name="cprs_nama" placeholder="Masukkan nama">
				...
				<div class="form-group col-md-6">
					...
					<select id="cprs_tingkat" name="cprs_tingkat" class="form-control">
						<option <?php if ($capresbem->cprs_tingkat == "1" ) echo 'selected' ; ?> value="1">1</option>
						<option <?php if ($capresbem->cprs_tingkat == "2" ) echo 'selected' ; ?> value="2">2</option>
						<option <?php if ($capresbem->cprs_tingkat == "3" ) echo 'selected' ; ?> value="3">3</option>
					</select>
				...
				<div class="form-group col-md-6">
					...
					<input value="<?php echo $capresbem->cprs_hp ?>" type="number" class="form-control" required id="cprs_hp" name="cprs_hp" placeholder="Masukkan singkatan">
					
				</div>
				<div class="form-group col-md-6">
					<label for="cprs_motto">Motto<span class="text-danger"><b style="color: red">*</b></span></label>
					<input value="<?php echo $capresbem->cprs_motto ?>" type="text" class="form-control" required id="cprs_motto" name="cprs_motto" placeholder="Masukkan motto">
					
				</div>
				
				<div class="form-group col-md-6">
					<label for="cprs_visi">Visi<span class="text-danger"><b style="color: red">*</b></span></label>
					<textarea class="form-control" rows="3" placeholder="Masukkan visi" id="cprs_visi" name="cprs_visi"><?php echo $capresbem->cprs_visi ?></textarea>
				</div>
				<div class="form-group col-md-6">
					<label for="cprs_password">Misi<span class="text-danger"><b style="color: red">*</b></span></label>
					<textarea class="form-control" rows="3" placeholder="Masukkan misi" id="cprs_misi" name="cprs_misi"><?php echo $capresbem->cprs_misi ?></textarea>
				</div>
                <div class="form-group col-md-6">
					...
					<input type="hidden" name="picture_old" value="<?php echo $capresbem->cprs_foto ?>" width="907px" height="640px">
				</div>
              </div>
              <!-- /.box-body -->
