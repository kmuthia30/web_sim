...
<script src="<?php echo base_url('assets/grafik/js/main.js')?>"></script>
<script src="<?php echo base_url('assets/grafik/js/bootstrap.min.js')?>"></script>
<script src="<?php echo base_url('assets/grafik/js/highcharts.js')?>"></script>
<script src="<?php echo base_url('assets/grafik/js/modules/exporting.js')?>"></script>